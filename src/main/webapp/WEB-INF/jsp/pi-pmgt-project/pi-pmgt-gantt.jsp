...
console.log(document.documentMode)
	   var GanttView=true,lockedDataIndex='';
    ...
    <script src="/pi-pmgt-common/js/ext/build/ext-all-rtl-debug.js?version=<%=version%>"></script>
    ...
    <script src="/pi-pmgt-common/js/resources/extgantt/js/gantt4.js?version=<%=version%>" type="text/javascript"></script>
    ...
    .resourcegrid-cls .x-form-cb-default,.resourcegrid-cls .x-form-cb-label-default{
    	margin-top: 2px;
    }
	</style>
...
<script language="javascript" type="text/javascript">
	  ...
	  function initWindow(){
          ...
          iframe.style.height="800px";
            // iframe.style.height=document.getElementById("p_i_plan_web_view_builder").style.height;
		    // iframe.style.width=targetNode.style.width;
	  }
	  initWindow();
    var pi_project_basePath=document.getElementById("pi_project_basePath").value;
	  var pi_pageId="planTree2",lockGridWidth=1000;
    </script>
</body>
</html>
