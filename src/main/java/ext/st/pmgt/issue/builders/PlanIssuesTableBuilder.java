 ...
 **/
public class PlanIssuesTableBuilder extends AbstractComponentBuilder {
    PIProject project=null;
    @Override
    public Object buildComponentData(ComponentParams params) throws PIException {
        PIPlan plan = (PIPlan)params.getNfCommandBean().getSourceObject();
        if (plan!=null){
            project=plan.getProject();
        }
        return STProjectIssueHelper.service.getAllProjectIssues(plan);
    }
    ...
    public ComponentConfig buildComponentConfig(Object componentData, ComponentParams params) throws PIException {
        ...
        tableConfig.setToolbarActionModel("projectRelatedIssuesToolBarCopyByPlan", params);
