 ...
 **/
public class PlanActivityRisksTableBuilder extends AbstractComponentBuilder {
    PIProject project=null;
    @Override
    public Object buildComponentData(ComponentParams params) throws PIException {
        PIPlanActivity piPlan = (PIPlanActivity) params.getNfCommandBean().getSourceObject();
