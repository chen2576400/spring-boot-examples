...
// * riskInformation
// */
//public class ProjectRisksInformationTableBuilder extends AbstractComponentBuilder {
//    @Override
...
//        }else if (contextObj instanceof STProjectRisk){
//            return Arrays.asList((STProjectRisk)contextObj);
//        }
...
//        tableConfig.setId("ProjectRisksInformationTable");//表格id
